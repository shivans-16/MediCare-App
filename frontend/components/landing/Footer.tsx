      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='py-8 border-t border-blue-700/50'>
          <div className='flex flex-col md:flex-row items-center justify-between gap-6'>
            {/* Footer bottom content if needed */}
            <div>
        ...
        <div className='py-6 border-t border-blue-700/50'>
          <div className='flex flex-col md:flex-row items-center justify-between gap-4'>
            <div className='text-blue-200 text-sm'>
              <p>&copy; 2026 MediCare+, Inc. All rights reserved</p>
            </div>
              ...
              {/* <div className='flex space-x-3'>
                {socials.map(({ name, icon: Icon, url }) => {
                  <a
                    ...
                    target='_blank'
                    rel='noopener noreferrer'
                    className='w-8 h-8 bg-blue-700/50 hove:bg-blue-600 rounded-full flex items-center justufy-center transition-colors duration-200'
                    aria-label={`Follow us on ${name}`}
                  >
                    <Icon className='w-4 h-4 text-white' />
                  </a>
