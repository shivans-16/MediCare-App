...
const LandingHero=()=>{
    ...
    return(
        ...
        <div className='flex flex-col sm:flex-row gap-4 justify-center mb-12'>
            ...
            <Button size='lg' variant='outline' className='w-full border-blue-600  to-blue-700 hover:bg-blue-50 rounded-full px-8 py-3 text-lg'>
             Login as Doctor
            </Button>
            </Link>
        </div>
     ...
     <section className='py-6'>'
        ...
        <div className='flex justify-center items-center overflow-x-auto gap-6 pb-2 scrollbar-hide max-auto'>
