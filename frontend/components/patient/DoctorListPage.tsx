...
import { FilterIcon, MapPin, Search, SearchIcon, Star, StarIcon, X } from 'lucide-react';
    ...
    return (
        <div className='min-h-screen bg-gray-50 pt-16'>
            ...
            <div className='bg-white border-b'>
                <div className='max-w-7xl mx-auto px-4 py-6'>
                    <div className='flex items-center justify-between mb-6'>
                        <div>
                            ...
                            <p className='text-gray-600 mt-1'>
                                Find the perfect healthcare provider as per your need
                            </p>
                        </div>
                    </div>
                    ...
                    <div className='mb-6'>
                        ...
                        <div className='flex overflow-x-auto pag-3 pb-2 scrollbar-hide'>
                            <Button
                            ...
                            {healthcareCategories.map((cat) => (
                                ...
                                >
                                    <div className={`w-6 h-6 ${cat.color} rounded-2xl flex items-center justify-center group-hover:shadow-xl transition-all duration-200`}>
                                        <svg className='w-6 h-6 text-white ' fill="current-color" viewBox='0 0 24 24'>
                                            <path d={cat.icon} />
                                        </svg>
                                    </div>
                                    {cat.title}
                        ...
                        <Card className='p-4 mb-4 bg-gray-50'>
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
                                <div className=''>
                                    ...
                                    <Select
                                        value={filters.specialization || ''} onValueChange={(value) => handleFilterChange('specialization', value)}
                                    >
                                        <SelectTrigger>
                                ...
                                <div className=''>
                                    ...
                                    <Select
                                        value={filters.city || ''} onValueChange={(value) => handleFilterChange('city', value)}
                                    >
                                        <SelectTrigger>
                                ...
                                <div className=''>
                                    <label className='text-sm font-medium mb-2 block'>SortBy</label>
                                    <Select
                                        value={filters.sortBy || ''} onValueChange={(value) => handleFilterChange('sortBy', value)}
                                    >
                                        <SelectTrigger>
                                            <SelectValue />
                                        </SelectTrigger>
            ...
            {/* <div className='max-w-7xl mx-auto px-4 py-8'>
                <div className='mb-4 text-sm tex-gray-600'>
                ...
                {loading ? (
                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
                     ...
                     <div className='grid grid-cols-1 sm:gird-cols-2 lg:grid-cols-3 gap-6'>
                      {doctors.map((doctor)=>(
                        <Card key={doctor._id} className='hover:shadow-xl transition-all duration-300 bg-white border-0 shadow-md h-full'>
                              <CardContent className='p-6 flex flex-cols h-full'>
                                <div className='text-center mb-4'>
                                
                                    <Avatar className='w-20 h-20 mx-auto mb-3'>
                                        <AvatarImage src={doctor.profileImage} alt ={doctor.name} className='object-cover'>
                                            <AvatarFallback className='bg-gradient-to-br from-blue-100 to text-blue-700 text-xl font-bold'>
            ...
            <div className='max-w-7xl mx-auto px-4 py-8'>
                <div className='mb-4 text-sm text-gray-600'>
                    {loading ? 'Searching...' : `${doctors?.length ?? 0} doctors found`}
                </div>
                ...
                {loading ? (
                            ...
                            <Card key={doctor._id} className='hover:shadow-xl transition-all duration-300 bg-white border-0 shadow-md h-full'>
                                <CardContent className='p-6 flex flex-col h-full'>
                                    <div className='text-center mb-4'>
                                        ...
                                        <p className='text-gray-500 text-xs mb-2'>{doctor.experience} years experience</p>
                                    ...
                                    <div className='spcae-y-2 mb-4 text-center'>
                                    ...
                                    <div className='mt-auto'>
                                        <Link href={`/patient/booking/${doctor._id}`} className='block'>
                                            <Button
                                                className='w-full bg-blue-600 hover:bg-blue-700 text-white rounded-lg ply-2 text-sm font-medium shadow-lg hover:shadow-xl transition-all'
                    ...
                    <Card className='p-12 text-center'>
                        ...
                        <p className='text-gray-500 mb-4'>Try adjusting you filters or search criteria</p>
